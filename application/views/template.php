...
<div class="wrapper">
    ...
    <section class="sidebar">
      <div class="user-panel">
        <div class="pull-left image">
          <img <?=ucfirst($this->fungsi->user_login()->username)?> src="<?=base_url()?>assets/dist/img/avatar04.png" class="img-circle" alt="User Image">
        </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li <?=$this->uri->segment(1) == 'stock' ? 'class="active"' : '' ?>><a href="<?=site_url('stock')?>"><i class="fa fa-circle-o"></i> Stock In</a></li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2021 <a href="https://adminlte.io">My Point Of Sale</a>.</strong> All rights
    reserved.
  </footer>
