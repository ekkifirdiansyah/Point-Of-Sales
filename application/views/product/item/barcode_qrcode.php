...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <?=$row->barcode?>
            <br><br>
            <a href="<?=site_url('item/barcode_print/' .$row->item_id)?>" target="_balnk" class="btn btn-default btn-sm">
    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <?=$row->barcode?>
            <br><br>
            <a href="<?=site_url('item/qrcode_print/' .$row->item_id)?>" target="_balnk" class="btn btn-default btn-sm">
                <i class="fa fa-print"></i> Print
            </a>
        </div>
    </div>
